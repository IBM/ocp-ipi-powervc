...
declare -a ENV_VARS
ENV_VARS=( "BASEDOMAIN" "BASTION_IMAGE_NAME" "BASTION_USERNAME" "CLOUD" "CLUSTER_DIR" "CLUSTER_NAME" "CONTROLLER_IP" "FLAVOR_NAME" "MACHINE_TYPE" "NETWORK_NAME" "RHCOS_FILENAME" "SSHKEY_NAME" )
